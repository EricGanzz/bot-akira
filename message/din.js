...
// STICKCMD
       ...
       if (xinz.multi) {
        ...
        const fakelokasi = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {locationMessage: {degreesLatitude: -7.0389318, degreesLongitude: 113.8969749, name: 'Akira', address: 'Halo', jpegThumbnail: fs.readFileSync('./media/din.jpg')}}}        
        const faketoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {productMessage: {product: {currencyCode: "BRL", title: 'AkiraBotz', priceAmount1000: 0, productImageCount: 0, productImage: {jpegThumbnail: fs.readFileSync('./media/din.jpg')}}, businessOwnerJid: "0@s.whatsapp.net"}}}        
        const fgc = {key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "62895619083555-1616169743@g.us"},"message": {"groupInviteMessage": {"groupJid": "62895619083555-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `By AkiraBotz`, thumbnail: fs.readFileSync('./media/din.jpg')}}}
        const ftext = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})},message: { "extendedTextMessage": {"text": `Akira Gantenkk`,"title": `Hmm`,'jpegThumbnail': fs.readFileSync(setting.pathImg)}}}
        ...
        let fakeLink = {
             ...
             "mediaUrl": "https://youtu.be/JRe5752LHPo"
        }        
        // Jam kontol
...
// Fake Yutube        
        ...
        "vcard": "BEGIN:VCARD\nVERSION:3.0\nN:Zetsu;\nFN:Zetsu\nORG:Z E T S U\nTITLE:\nitem1.TEL;waid=6285719194581\nitem1.X-ABLabel:Telepon\nX-WA-BIZ-DESCRIPTION:Meng Zetsu dulu gk see\nX-WA-BIZ-NAME:Fax\nEND:VCARD"
        }
...
//Ucapan Waktunya kak
        ...
        if(time2 < "23:59:00"){
                 ...
                 if(time2 < "11:00:00"){
                 var ucapanWaktu = 'Good morning user'
                                         }
                 if(time2 < "05:00:00"){
                 var ucapanWaktu = 'Good night User'
                                         }
...
xinz.sendMessage(from, me, text, { quoted: msg, contextInfo: {
            ...
            case prefix+'report':
                ...
                case prefix+'botpatnert':{
                    let listown = [`${ownerNumber}`,'6281916849086','6285719194581','6287863200063']
                    let arrey = []
                    ...
                    xinz.sendMessage(from, { contacts: arrey }, MessageType.contactsArray, {quoted: msg })
                                    .then((res) => xinz.sendMessage(from, 'Patnert Zetsu - Bot >_<', text, {quoted: res}))
              ...
              case prefix+'help':{  
                ...
                let menu1 = `${help(ucapanWaktu, timeWib, timeWita, timeWit, sender, email, owner, ig)}`
        ...
        break     
           ...
           case prefix+'fakehidetag':{
            ...
            case prefix + 'limit': case prefix + 'ceklimit': case prefix + 'balance': case prefix + 'glimit':
                ...
                break
            case prefix+'owner': //Dah di fix ama Dinata
            case prefix+'creator':{
                const buttons = [
                   {buttonId: prefix+'sc', buttonText: {displayText: '📄SC BOT'}, type: 1},
                   {buttonId: prefix+'dinatayt', buttonText: {displayText: '🔎YOUTUBE'}, type: 1}
                      ]
                let culek =` Ya kak Butuh info owner saya ?`
                const buttonMessage = {
                      contentText: culek,
                      footerText: `Creator Bot to Zetsu`,
                      buttons: buttons,
                      headerType: 1
                                        }                      
                xinz.sendContact(from, ownerNumber.split("@")[0], setting.ownerName, msg)
                .then((res) => xinz.sendMessage(from, buttonMessage, MessageType.buttonsMessage, {quoted: res }))
                }
                break
            case prefix + 'dinatayt':
            case prefix + 'cenelbotdinata':{
                 textImg(`Channel Zetsu Bot https://youtube.com/channel/UCbDjAeUqxnY5g1y4kKFVbVA`)
                 }
            break
...
let menuhe =`*────「 BOT STATS 」────*
✗⃝🔮 *Bot name* : _${botName}_
✗⃝🔖 *Creator* : _@${owner}_
✗⃝🌐 *Owner* : _${ownerName}_
✗⃝🌍 *Active* : _${runtime(process.uptime())}_
✗⃝🖥️ *Speed* : 
_${latensii.toFixed(4)} detik_
✗⃝🕊️ *Total chat* : _${totalchat.length}_
✗⃝📌️ *Group Chat* : _${giid.length}_
✗⃝📡️ *User Bot* : _${pendaftar.length}_

${menu(prefix, emote)}
 
*Bot WhatsApp simple*
Creator By Zetsu Official`
